...
public class TestDataImport extends SetupInit {
	private static final String PLATEFORMCONFIGURATION_FILE_PATH = test_data_folder_path
			+ "Dh_Mobifin_5.0_BusinessAndCRUDData.xls";
	private static final String OPERATORCONFIG_FILE_PATH = test_data_folder_path
			+ "Dh_Mobifin_5.0_BusinessAndCRUDData.xls";
