...
public class OperatorConfigSystemOperatorEntity extends Common{
	 ...
	 * For Platform Configuration - SystemOperatorEntity - Add
	...
	/**
	 * @author shivani.patel         
	 * For Platform Configuration - SystemOperatorEntity - Edit
	 * @creation date 24/09/2019
	 */
	...
	/**
	 * @author shivani.patel
	 * For Platform Configuration - SystemOperatorEntity - Delete
	 * @creation date 24/09/2019
	 */
	...
	public void deleteSystemOperatorEntity(Map<Object, Object> map) {
		...
		if (operatorConfigSystemOperatorEntityWeb.deleteSystemOperatorEntity(map, getMapKeys(map)))
			verifyFalse(operatorConfigSystemOperatorEntityWeb.verifyDeletedSystemOperatorEntity(map, getMapKeys(map)));
	}
	/**
